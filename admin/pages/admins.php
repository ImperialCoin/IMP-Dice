...
<table class="vypis_table">
  <tr class="vypis_table_head">
    ...
    while ($row=mysql_fetch_array($qu)) {
      ...
      echo '<td>'.$row['id'].'</td>';
      echo '<td class="a__ali">'.$row['username'].'</td>';
      echo '<td><a href="#" onclick="javascript:removeAdmin('.$row['id'].');return false;" title="Delete Admin"><img src="./imgs/cross.png" style="width: 16px;"></a>&nbsp;<a href="#" onclick="javascript:edit_admin('.$row['id'].',\''.$row['username'].'\');return false;" title="Edit Admin" id="edit_karos"><img src="./imgs/edit.png" style="width: 16px;"></a></td>';
      echo '</tr>';
    }
    ?>
</table>
