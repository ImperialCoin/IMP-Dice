...
<html>
  <head>
    ...
    <?php include './themes/config.php'; ?>
    <link rel="stylesheet" type="text/css" href="themes/<?php echo $activeTheme; ?>/main.css">
  ...
  <body>
              ...
              <table width="100%">
                <tr>
                  ...
                  <td valign="top" align="left">
                    <a class="balanceRefresh" href="#" onclick="javascript:refreshBalance();return false;"><img src="./content/images/balance_refresh.png" style="position: relative; top: 8px; width: 24px; height: 26px;"></a>
                  </td>
    ...
    <div id="all" class="downer">
      <div id="content" class="stats_switcher">
        ...
        <?php if ($settings['giveaway']==1) { ?><a href="#" class="mini" onclick="javascript:_stats_content('giveaway');return false;" id="_st_giveaway"><img src="./content/images/icons/giveaway.png" style="position: relative; top: 5px; width: 35px; height: 35px;"></a><?php } ?>
        <a href="#" class="mini" onclick="javascript:_stats_content('news');return false;" id="_st_news"><img src="./content/images/icons/news.png" style="position: relative; top: 5px; width: 35px; height: 35px;"></a> 
        <?php if ($settings['chat_enable']==1) { ?><a href="#" class="mini" onclick="javascript:_stats_content('chat');return false;" id="_st_chat"><img src="./content/images/icons/chat.png" style="position: relative; top: 5px; width: 35px; height: 35px;"></a><?php } ?>  
        <?php if ($settings['bot_enable']==1) { ?><a href="#" class="mini" onclick="javascript:robotLayoutChange();return false;" id="_st_automat"><img src="./content/images/icons/automat.png" style="position: relative; top: 5px; width: 35px; height: 35px;"></a><?php } ?>
        <a href="#" class="mini" onclick="javascript:_stats_content('stats');return false;" id="_st_stats"><img src="./content/images/icons/stats.png" style="position: relative; top: 8px; width: 35px; height: 28px;"></a>
      </div>
    </div>
